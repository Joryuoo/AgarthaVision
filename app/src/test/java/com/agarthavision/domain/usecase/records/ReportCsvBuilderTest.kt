...
class ReportCsvBuilderTest {
    ...
    fun `builds session report csv with header and rows`() {
        ...
        val expected = """
            ...
            sample_id,captured_at,verified_at,model_class,model_confidence,expert_class,verdict,stage,gps_lat,gps_lng,gps_accuracy,is_manual,user_note,model_version
            sample-1,1970-01-01T00:00:01Z,1970-01-01T00:00:02Z,Ascaris lumbricoides,0.91,Ascaris lumbricoides,confirmed,unfertilized,10.0,20.0,5.0,false,"note,one",model-1
