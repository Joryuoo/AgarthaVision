...
(`schema.ts:508-513`). What this repo defines is the four policy decisions in
...
`metadata`, `path_tokens`, `version` — are catalogued at `schema.ts:508-544`. Do not write any
of them directly.
