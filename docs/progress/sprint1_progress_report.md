...
|------|----------------------------------------------------------------------|-------|--------|
| 1.0  | `LoginScreen` + `LoginViewModel` (Supabase Auth)                     | Beansman | ✅ done 2026-05-25 — implemented + `gradlew.bat assembleDebug` green; live auth test pending local Supabase keys/test account |
